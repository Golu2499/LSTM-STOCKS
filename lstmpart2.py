# -*- coding: utf-8 -*-
"""
Created on Thu Sep 19 23:49:33 2019
...
INPUT_PATH = "hdfcbank.csv"
OUTPUT_PATH = "/outputs/lstm_best_7-3-19_12M//"+iter_changes
...
df_ge = pd.read_csv(os.path.join(INPUT_PATH), engine='python')
print(df_ge.shape)
print(df_ge.columns)
